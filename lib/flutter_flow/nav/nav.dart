...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => EnterWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => EnterWidget(),
        ),
        FFRoute(
          name: 'authorization',
          path: '/authorization',
        ...
        FFRoute(
          name: 'raiting_page',
          path: '/raitingPage',
          builder: (context, params) => RaitingPageWidget(),
        ),
        FFRoute(
          name: 'profile_editor_page',
          path: '/profileEditorPage',
          builder: (context, params) => ProfileEditorPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'certificate',
          path: '/certificate',
          builder: (context, params) => CertificateWidget(),
        ),
        FFRoute(
          name: 'coupon',
          path: '/coupon',
        ...
        FFRoute(
          name: 'otherCopy',
          path: '/otherCopy',
          builder: (context, params) => OtherCopyWidget(),
        )
